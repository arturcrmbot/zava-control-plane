...
| Capability | Approach |
|-----------|---------|
| Voice screening | [GPT-Realtime](https://learn.microsoft.com/en-us/azure/foundry/openai/how-to/realtime-audio) as speech-to-speech front end. [ACS Call Automation](https://learn.microsoft.com/en-us/azure/communication-services/concepts/call-automation/call-automation) for telephony. [MAI-Transcribe-1](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/mai-transcribe) for transcription (preview, GA targeted Q4 2026). [MAI-Voice-1](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/mai-voices) for TTS (preview, East US only). Tool calls to GHCP SDK backend for reasoning and scoring. |
