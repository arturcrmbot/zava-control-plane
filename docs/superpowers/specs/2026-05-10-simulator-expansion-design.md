...
| TASK-118 | Update [`docs/visualisation.md` "Local-dev recipes"](../../visualisation.md#local-dev-recipes) — append the 5 new endpoints with one-line curl recipes. | | |
...
curl -X POST http://localhost:3101/api/simulator/cross-function-vendor \
     -H 'Content-Type: application/json' -d '{}'

# 2. Meta-workflow burst — parent + 4 children across 2+ floors
curl -X POST http://localhost:3101/api/simulator/meta-spawn-burst \
     -H 'Content-Type: application/json' -d '{}'

# 3. Decision storm — 25 decisions in 60 s
curl -X POST http://localhost:3101/api/simulator/decision-storm \
     -H 'Content-Type: application/json' -d '{}'

# 4. Fast-forward 24 h — morning-sweep fires
curl -X POST http://localhost:3101/api/simulator/cadences/fast-forward \
     -H 'Content-Type: application/json' -d '{"seconds": 86400}'

# 5. Kick a named ambient agent
curl -X POST http://localhost:3101/api/simulator/ambient/finance-anomaly-watch/kick \
     -H 'Content-Type: application/json' -d '{}'
...
- **Visualisation contributor guide** → [../../visualisation.md#visualisation-contributor-guide](../../visualisation.md#visualisation-contributor-guide)
