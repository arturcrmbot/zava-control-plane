...
> Source: [ZavaET-POC1-Finance-Expense-Compliance-260331.docx](../ZavaET-POC1-Finance-Expense-Compliance-260331.docx)
...
Zava manages employee expense claims across **15+ expense management systems** (Workday, SAP Concur, Chrome River, local tools) with **100+ local policies** across markets and agencies. Approximately **130 FTEs** currently review claims manually. Non-compliant spend across Zava is estimated to be significant. Detection is reactive; there is no proactive compliance culture.
...
- **Target accuracy: ≥ 95%** correct classification against the provided benchmark dataset (Zava internal pilot achieved 97.6%).
...
- **Cost model:** Transparent pricing covering consumption vs. subscription models; breakdown for pilot scale vs. full Zava rollout; include model inference costs, platform fees, and storage.
...
| Total cost of ownership | 15% | Transparent, predictable, scalable pricing. VML NA pilot vs. full Zava rollout economics. |
...
| Benchmark classifications | Zava-labelled Red/Amber/Green classifications for the expense dataset (ground truth for evals) |
...
- **Environment:** Vendor-hosted; Zava provides all synthetic data and sandbox/dummy API credentials listed in §8.
...
*This document is confidential and intended solely for the named recipient vendors. Any reproduction or distribution without explicit permission from Zava is prohibited.*
