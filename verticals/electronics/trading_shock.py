...
class StoryStage:
    ...
    def view(self) -> dict[str, Any]:
        profile = ELECTRONICS_PROCESS_PROFILES[self.workflow_type]
        domain = ELECTRONICS_DOMAINS[self.workflow_type]
        return {
            ...
            "hitl_persona": profile.hitl_persona,
...
class TradingShockState:
    ...
    def __post_init__(self) -> None:
        self.id = f"launch-shock:{self.seed}"
        self._stages = {
