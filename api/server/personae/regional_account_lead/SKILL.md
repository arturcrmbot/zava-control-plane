...
allowed-tools:
workflow_label: Revenue — regional
...
decision_policy: |
    ...
    action = (context or {}).get("action") or "regional_account_lead_decision"
...
When `regional_account_lead` is NOT in `PERSONA_AUTO_CLOSE`, the gate stays open
indefinitely.
