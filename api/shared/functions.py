"""api/shared/functions.py — organisational function declarations.
...
ALL_FUNCTIONS = MappingProxyType(dict(FUNCTIONS))
...
if _select_vertical(os.environ)[0] == "telco":
    FUNCTIONS = {
        ...
        "customer-success": ALL_FUNCTIONS["customer-success"],
    }
else:
    FUNCTIONS = {
        name: function
