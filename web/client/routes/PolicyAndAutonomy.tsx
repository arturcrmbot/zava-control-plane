...
export default function PolicyAndAutonomy() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <div className="text-lg font-semibold text-slate-900">Policy &amp; Autonomy</div>
        <div className="text-xs text-slate-500 mt-1 max-w-3xl">
        ...
        <div className="space-y-2">
          {policies.map(p => (
            <button key={p.id}
              ...
              <div className="text-sm font-medium text-slate-800">{p.id}</div>
