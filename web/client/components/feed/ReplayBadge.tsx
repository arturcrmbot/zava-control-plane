...
export function ReplayBadge() {
  ...
  const label = date ? `live replay — recorded ${date}` : "live replay";
      ...
      {open && (
        ...
        >
          ...
          >
            ...
            <p>
              This is a recorded 2-hour loop. All decisions were made by autonomous personae.
              The buttons you see are real but disabled — clicking them does nothing.
            </p>
