...
/**
 * Bottom-of-rail leaderboard: top 6 teams (functions) by current
 * in-flight load, with bars proportional to load. Instant operator
 * readout of where the work is concentrated.
 */
export function HotFunctions({ inFlight, functions, onFunctionClick }: HotFunctionsProps) {
  ...
  return (
    ...
    >
      ...
      >
        <span>Busiest teams</span>
        <span style={{ color: "#475569", fontSize: 9 }}>· active cases</span>
      </div>
