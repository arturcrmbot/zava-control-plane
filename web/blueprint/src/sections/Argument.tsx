...
const captions: { label: string; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body:
      "Workday, SAP, Salesforce, Mediaocean, ServiceNow, Greenhouse, Graph \u2014 and your third-party APIs \u2014 surfaced as MCP tools with negotiated auth, schemas and contracts. The MCP servers are not agentic themselves. They are pure capability. Agents borrow them.",
  },
  {
      ...
      <div className="column--wide stack-xl">
        <header className="argument__intro stack">
          ...
          <p className="body">
            ...
            is the newest piece of the four. Together &mdash; and only
