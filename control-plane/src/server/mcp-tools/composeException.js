...
export function composeExceptionTool(store, _bus, audit) {
    return defineTool("compose-exception", {
        ...
        skipPermission: true,
        handler: async ({ workflowId, severity, category, summary, recommendation, options, relatedPolicyRefs, bulkCandidateIds, confidence, }) => {
            ...
            const exc = {
                ...
                relatedPolicyRefs: (relatedPolicyRefs ?? []),
                bulkCandidateIds,
