...
import type {
  Workflow, PhaseName, OtelSpan, ExceptionCategory
} from "@shared/types";
...
const vendorsFixture = require("../fixtures/vendors.json") as Array<{
  id: string; name: string; country: string; sanctioned: boolean; creditRating: string;
}>;
const poFixture = require("../fixtures/purchase-orders.json") as Array<{
  id: string; vendorId: string; amount: number; currency: string; lineCount: number; openBalance: number;
}>;
const agenciesFixture = require("../fixtures/agencies.json") as Array<{
  id: string; market: string; region: string;
}>;
